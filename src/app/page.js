  ...
  return (
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <header className="bg-blue-600 text-white py-10 text-center">
        ...
        <p className="mt-4 text-lg">Welcome to my professional portfolio! Below are some of my GitHub repositories and projects.</p>
      </header>
          ...
          {repos.length === 0 ? (
            ...
            repos.map((repo) => (
              <div key={repo.id} className="bg-gray-50 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">{repo.description ? repo.description : "No description available"}</p>
      ...
      <section className="p-10 text-center bg-gray-200">
        ...
        <div className="flex justify-center gap-6">
          <a href="https://www.linkedin.com/in/mohan-lal-b79790126/" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-xl">
            LinkedIn
          </a>
          <a href="https://github.com/mhnuk2007" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-xl">
            GitHub
          </a>
        </div>
      </section>
