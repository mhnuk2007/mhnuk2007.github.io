          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-slate-400 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                ...
                focused on building reliable backend systems, REST APIs, and
                cloud-native applications using Java, Spring Boot, modern
              ...
              <div className="mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-x-8 gap-y-3 text-slate-500">
            ...
            <div className="relative">
              <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 group">
                ...
                {/* Decorative Rings */}
                <div className="absolute inset-0 rounded-full border-2 border-slate-800 rotate-12 scale-105 transition-transform duration-700 group-hover:rotate-45" />

                <div className="absolute inset-0 rounded-full border-2 border-brand-primary/20 -rotate-6 scale-110 transition-transform duration-700 group-hover:-rotate-12" />
